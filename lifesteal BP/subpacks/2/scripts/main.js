...
Mc.system.runInterval(() => {
    for (const player of Mc.world.getPlayers({ tags: ["unitx:ban"] })) {
        player.removeTag("unitx:ban")
        player.addTag(banTag)
        Mc.world.setDynamicProperty(banId + player.name, true)
        try{Mc.world.scoreboard.removeObjective("unitx:ban")}catch(e){}
    }
    for (const player of Mc.world.getPlayers({ tags: ["spectorator"] })) {
        player.removeTag("spectorator")
        player.addTag(spectoratorTag)
        Mc.world.setDynamicProperty(spectoratorId + player.name, true)
    }
